var Surely = (function(coverage) {
  return coverage
    ? require('./surely-cov')
    : require('./surely');
})(process.env.USE_COVERAGE);

module.exports.testNumbers = function(t) {
...
module.exports.testAsync = function(t) {
...
module.exports.testObjects = function(t) {
...
module.exports.testOptional = function(t) {
  ...
  var now = new Date();
  t.equal(optional(now), +now, 'Surely with an optional param is valid when that param is provied');

  t.done();
};

module.exports.testDefaultParams = function(t) {
